...
class MobileNetV1(nn.Module):
    def __init__(self):
        ...
        self.model = nn.Sequential(
            conv_full(1, 32, 2), # 32x32
            conv_depthwise(32, 64, 1), # 32x32
            conv_depthwise(64, 128, 2), # 16x16
            conv_depthwise(128, 128, 1), # 16x16
            conv_depthwise(128, 256, 2), # 8x8
            conv_depthwise(256,256, 1), # 8x8
            conv_depthwise(256,512, 2), # 4x4
            conv_depthwise(512,512, 1), # 4x4
...
class BasicConv2d(nn.Module):
    def __init__(self, chn_in: int, chn_out: int, nxn: int, pad: int, dilate: int):
        ...
        self.BatchNorm = nn.BatchNorm2d(chn_out, eps = 0.0001)
        self.ReLu = nn.ReLU()
